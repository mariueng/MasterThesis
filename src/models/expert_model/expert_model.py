...
def train_model(dir_path):
    ...
    training_data["1 day lag"] = training_data["Trans System Price"].shift(24)
    training_data["2 day lag"] = training_data["Trans System Price"].shift(48)
    training_data["1 week lag"] = training_data["Trans System Price"].shift(168)
    ...
    for day in days_in_year:
        ...
        max_yesterday = max(yesterday_df["Trans System Price"])
        min_yesterday = min(yesterday_df["Trans System Price"])
    ...
    y = training_data[["Trans System Price"]]
