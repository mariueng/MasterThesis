...
def plot_correlation_matrix_first():
    replace_dict = {"System Price": "Sys. price", "Total Vol": "Volume", "Total Hydro": "Hydro", "Total Hydro Dev":
                    "Hydro dev.", "Temp Norway": "Temp. Norway", "Prec Norway 7": "Prec. Norway 7", "Low Carbon": "Low carbon",
                    "Prec Norway": "Prec. Norway", "Demand": "Consumption", "Supply": "Production", "Wind Prod": "Wind prod."}
    ...
    plt.xticks(np.arange(len(df.columns)) + 0.5, ticks, rotation=55, size=11)
